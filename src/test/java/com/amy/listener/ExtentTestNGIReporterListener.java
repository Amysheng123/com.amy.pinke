...
public class ExtentTestNGIReporterListener implements IReporter {
    ...
    private static final String FILE_NAME = "Test report_" + form + hour + minute + second + ".html";
    ...
    private void init() {
        ...
        htmlReporter.config().setDocumentTitle("Amy自动化测试报告");
        htmlReporter.config().setReportName("Amy自动化测试报告");
        ...
        if (tests.size() > 0) {
            ...
            for (ITestResult result : treeSet) {
                ...
                for (Object param : parameters) {
                    Object caseId = ((HashMap) param).get("caseId");
                    if(caseId != null){
                        name = result.getMethod().getMethodName()+"_"+caseId.toString();
                        break;
                    }
                   // name += param.toString();
                }
